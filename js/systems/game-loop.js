...
import { story, choices, userProfile, playerChoices, setStory, appendStory, setChoices } from '../state.js';
...
export async function startGame() {
    ...
    try {
        ...
        setStory(gameIntro); // Set initial story
        updateStory();
        speakText(story);
        ...
        setStory("The dark forces stir as you begin your journey...");
        updateStory();
    } finally {
...
export async function generateChoices() {
    ...
    try {
        ...
        const newChoices = choiceLines.map((line, index) => {
