...
export function updateStory() {
    ...
    storyCtn.textContent = story;
    storyCtn.scrollTop = storyCtn.scrollHeight; // Auto-scroll to bottom
}
...
export function toggleGameMenu() {
    window.menuOpen = !window.menuOpen; // Use window scope for simplicity
...
export function toggleTTS() {
    ...
    const toggleBtn = document.getElementById('toggleTtsBtn');
    const ttsIcon = toggleBtn.querySelector('.ttsIcon');
